...
my_open = open('loss-densenet161.txt', 'a')
# save model name
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_classes', type=int, default=6,
                        help="""num classes""")
    parser.add_argument('--model_path', type=str, default='model_densenet16_1',
        ...
        for epoches in range(1, 31):
            ...
            for images, labels in train_loader:
		        ...
		        #print("train batch-size:",temp)
                    ...
                    #打印出来时间信息
            print("161-Epoch:", epoches, "Loss:", loss.item(), "Time:", (end-start) * (30-epoches))
